            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if(constraint == null || constraint.length() == 0){
                    ...
                    for(UserModel userModel: getUserModelListFilter){
                        if(userModel.getFirstName().toLowerCase().contains(searchStr) || userModel.getLastName().toLowerCase().contains(searchStr) || userModel.getUserPhone().toLowerCase().contains(searchStr)){
